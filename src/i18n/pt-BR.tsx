const ptBR = {
  ...
  entities: {
    funeraria: {
        ...
        label: 'Funerarias',
        menu: 'Funerarias',
        exporterFileName: 'Funeraria_exportados',
        list: {
          menu: 'Funerarias',
          title: 'Funerarias',
        },
        create: {
          success: 'Funeraria salvo com sucesso',
        },
        update: {
          success: 'Funeraria salvo com sucesso',
        },
        destroy: {
          success: 'Funeraria deletado com sucesso',
        },
        destroyAll: {
          success: 'Funeraria(s) deletado com sucesso',
        },
        edit: {
        ...
        new: {
          title: 'Novo Funeraria',
        },
        view: {
          title: 'Visualizar Funeraria',
        },
        importer: {
          title: 'Importar Funerarias',
          fileName: 'funeraria_template_importacao',
          hint:
    ...
    cerimonia: {
        ...
        label: 'Cerimonias',
        menu: 'Cerimonias',
        exporterFileName: 'Cerimonia_exportados',
        list: {
          menu: 'Cerimonias',
          title: 'Cerimonias',
        },
        create: {
          success: 'Cerimonia salvo com sucesso',
        },
        update: {
          success: 'Cerimonia salvo com sucesso',
        },
        destroy: {
          success: 'Cerimonia deletado com sucesso',
        },
        destroyAll: {
          success: 'Cerimonia(s) deletado com sucesso',
        },
        edit: {
          title: 'Editar Cerimonia',
        },
        fields: {
          id: 'Id',
        ...
        new: {
          title: 'Novo Cerimonia',
        },
        view: {
          title: 'Visualizar Cerimonia',
        },
        importer: {
