const es = {
  ...
  entities: {
    funeraria: {
        ...
        label: 'Funerarias',
        menu: 'Funerarias',
        exporterFileName: 'exportacion_funeraria',
        list: {
          menu: 'Funerarias',
          title: 'Funerarias',
        },
        create: {
          success: 'Funeraria guardado con éxito',
        },
        update: {
          success: 'Funeraria guardado con éxito',
        },
        destroy: {
          success: 'Funeraria eliminado con éxito',
        },
        destroyAll: {
          success: 'Funeraria(s) eliminado con éxito',
        },
        edit: {
    ...
    cerimonia: {
        ...
        label: 'Cerimonias',
        menu: 'Cerimonias',
        exporterFileName: 'exportacion_cerimonia',
        list: {
          menu: 'Cerimonias',
          title: 'Cerimonias',
        },
        create: {
          success: 'Cerimonia guardado con éxito',
        },
        update: {
          success: 'Cerimonia guardado con éxito',
        },
        destroy: {
          success: 'Cerimonia eliminado con éxito',
        },
        destroyAll: {
          success: 'Cerimonia(s) eliminado con éxito',
        },
        edit: {
