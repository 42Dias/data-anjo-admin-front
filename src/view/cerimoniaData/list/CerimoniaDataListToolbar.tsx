...
function cerimoniaDataToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    cerimoniaDataSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    cerimoniaDataSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="cerimoniaData-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="cerimoniaData-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="cerimoniaData-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="cerimoniaData-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      {hasPermissionToCreate && (
        <Link to="/cerimonia/presenca/new">
      ...
      {hasPermissionToImport && (
        <Link to="/cerimonia/presenca/importer">
          <button className="btn btn-primary" type="button">
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=cerimoniaData">
...
export default cerimoniaDataToolbar;
