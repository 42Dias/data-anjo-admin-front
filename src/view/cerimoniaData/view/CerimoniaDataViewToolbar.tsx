...
import cerimoniaSelectors from 'src/modules/cerimoniaData/cerimoniaDataSelectors';
...
function CerimoniaViewToolbar(props) {
  const [
...
export default CerimoniaViewToolbar;
