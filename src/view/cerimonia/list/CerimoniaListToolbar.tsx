...
function CerimoniaToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    cerimoniaSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    cerimoniaSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="cerimonia-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="cerimonia-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="cerimonia-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="cerimonia-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=cerimonia">
...
export default CerimoniaToolbar;
